...
SOURCE_ROOT = SERVICE_ROOT / "cloud/services/template_generation/resources/source"
GENERATED_ROOT = SERVICE_ROOT / "cloud/services/template_generation/engine/cardplan/generated"
PROMPT_GROUPS = {
    "selection": (
...
def _python_string_constant(name: str, value: str) -> str:
    """Render a Python string constant without generated overlong lines."""
    chunks: list[str] = []
    current = ""
...
def _build() -> tuple[str, str]:
    ...
    prompts_text = (
        ...
        f"{_python_string_constant('SELECTION_SYSTEM_PROMPT', prompt_values['selection'])}\n\n"
        ...
        f"{_python_string_constant('BODY_SYSTEM_PROMPT_KERNEL', prompt_values['body'])}\n"
        f"\nUX_MIXED_PROMPT_VERSION = {PROMPT_GROUPS['ux_mixed'][0]!r}\n"
        f"UX_MIXED_PROTOCOL_VERSION = {PROMPT_GROUPS['ux_mixed'][1]!r}\n"
        f"{_python_string_constant('UX_MIXED_SYSTEM_PROMPT_KERNEL', prompt_values['ux_mixed'])}\n"
    )
