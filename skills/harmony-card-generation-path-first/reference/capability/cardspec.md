...
- `arguments` 是端侧能力入参配置，使用由用户需求或默认策略确定的 JSON 值；不要把 DSL 的 `{"path":...}` 或 `formatString` 绑定对象写进 `arguments`，除非能力 `inputSchema` 明确要求这种对象结构。
...
```json
{"id":"current_value","component":"Text","content":{"path":"/data/weather/current/temperatureText"}}
{"id":"event_list","component":"Column","children":{"componentId":"event_template","path":"/data/calendar/items"}}
{"id":"event_title","component":"Text","content":{"path":"title"}}
